...
class BasePage:
    ...
    def _is_not_displayed(self, locator: tuple[str, str], time: int = 10):
        wait = WebDriverWait(self._driver, time)
    ...
    def _get_attribute_value(self, locator: tuple[str, str], attr: str, time: int = 10) -> str:
        self._wait_until_element_is_visible(locator, time)
        return self._find(locator).get_attribute(attr)
